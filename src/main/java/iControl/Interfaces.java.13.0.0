...
private LocalLBCipherGroupBindingStub m_LocalLBCipherGroup = null;
private LocalLBCipherRuleBindingStub m_LocalLBCipherRule = null;
...
private LocalLBProfileDiameterRouterBindingStub m_LocalLBProfileDiameterRouter = null;
private LocalLBProfileDiameterSessionBindingStub m_LocalLBProfileDiameterSession = null;
...
private LocalLBProfileIPsecALGBindingStub m_LocalLBProfileIPsecALG = null;
...
private LocalLBProfileTrafficAccelerationBindingStub m_LocalLBProfileTrafficAcceleration = null;
...
private ManagementCertificateValidatorOCSPBindingStub m_ManagementCertificateValidatorOCSP = null;
...
public LocalLBCipherGroupBindingStub getLocalLBCipherGroup() throws Exception { if (!m_bInitialized ) { throw new IllegalStateException("Not Initialized"); } if (null == m_LocalLBCipherGroup ) { m_LocalLBCipherGroup = (iControl.LocalLBCipherGroupBindingStub) new iControl.LocalLBCipherGroupLocator().getLocalLBCipherGroupPort(new java.net.URL(buildURL())); } setupInterface(m_LocalLBCipherGroup); return m_LocalLBCipherGroup;}
public LocalLBCipherRuleBindingStub getLocalLBCipherRule() throws Exception { if (!m_bInitialized ) { throw new IllegalStateException("Not Initialized"); } if (null == m_LocalLBCipherRule ) { m_LocalLBCipherRule = (iControl.LocalLBCipherRuleBindingStub) new iControl.LocalLBCipherRuleLocator().getLocalLBCipherRulePort(new java.net.URL(buildURL())); } setupInterface(m_LocalLBCipherRule); return m_LocalLBCipherRule;}
...
public LocalLBProfileTrafficAccelerationBindingStub getLocalLBProfileTrafficAcceleration() throws Exception { if (!m_bInitialized ) { throw new IllegalStateException("Not Initialized"); } if (null == m_LocalLBProfileTrafficAcceleration ) { m_LocalLBProfileTrafficAcceleration = (iControl.LocalLBProfileTrafficAccelerationBindingStub) new iControl.LocalLBProfileTrafficAccelerationLocator().getLocalLBProfileTrafficAccelerationPort(new java.net.URL(buildURL())); } setupInterface(m_LocalLBProfileTrafficAcceleration); return m_LocalLBProfileTrafficAcceleration;}
