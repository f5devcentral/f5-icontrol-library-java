...
:	Set JAVALIB=D:\src\perforce\DevCentral\DC4\Labs\iControlAssembly\java\3rdparty\jar\Axis1.fix2
...
:CLASSES
	...
	for %%s in (*.java) do echo Compiling %%s...& %JAVAC% %JAVAC_FLAGS% -source 5 -classpath %AXIS_CLASSPATH%;.. -d ..\..\classes %%s
	cd ..\..
